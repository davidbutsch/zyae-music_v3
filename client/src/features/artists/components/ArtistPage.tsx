...
import { Artist, useArtist } from "@/features/artists";
import {
  Box,
  Button,
  Stack,
...
export const ArtistPage = () => {
  ...
  const artist = useArtist("UCprAFmT0C6O4X0ToEXpeFTQ") as unknown as Artist;
  ...
  //     banner: {
  //       mobile:
  //         "https://lh3.googleusercontent.com/MguDXxYf87GzP4rPlYeYbzANXx68Rp4U67R7qd2drvZDXCg_-3XC2SodMxEZHaTU6wxsbTCNow=w1440-h1440-p-l90-rj",
  //       desktop:
  //         "https://lh3.googleusercontent.com/MguDXxYf87GzP4rPlYeYbzANXx68Rp4U67R7qd2drvZDXCg_-3XC2SodMxEZHaTU6wxsbTCNow=w1440-h800-p-l90-rj",
  //     },
  //   },
  //   tracks: {
